        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="px-3 py-1 bg-brand-orange/10 text-brand-orange text-xs font-bold uppercase tracking-widest rounded-full mb-3 inline-block">
                Sharjah Technical Guides
              </span>
              <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                iPhone Hardware Guides & Related Services
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link 
                to="/blog/iphone-18-repair-screen-replacement-sharjah-uae"
                className="group bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-brand-orange/40 transition-all flex flex-col justify-between"
              >
                <div>
                  <div className="w-10 h-10 rounded-xl bg-orange-50 dark:bg-orange-950/40 text-brand-orange flex items-center justify-center font-bold mb-4">
                    18
                  </div>
                  <h3 className="font-bold text-slate-900 dark:text-white group-hover:text-brand-orange transition-colors text-base mb-2">
                    iPhone 18 & 18 Pro Max Repair Guide
                  </h3>
                  <p className="text-xs text-slate-600 dark:text-slate-400 line-clamp-3">
                    Ceramic Shield 2.0 OLED replacement, A20 Pro logic board micro-soldering, and repair cost comparison in Sharjah.
                  </p>
                </div>
                <div className="mt-4 flex items-center text-xs font-semibold text-brand-orange gap-1 group-hover:translate-x-1 transition-transform">
                  Read Guide <ArrowRight className="w-3.5 h-3.5" />
                </div>
              </Link>

              <Link 
                to="/blog/iphone-16-pro-max-repair-screen-battery-sharjah"
                className="group bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-brand-orange/40 transition-all flex flex-col justify-between"
              >
                <div>
                  ...
                  <h3 className="font-bold text-slate-900 dark:text-white group-hover:text-brand-orange transition-colors text-base mb-2">
                    iPhone 16 Pro Max Repair & Screen Fix
                  </h3>
                  <p className="text-xs text-slate-600 dark:text-slate-400 line-clamp-3">
                    Fixing capacitive Capture Buttons, hairline bezel cracks, and rapid UAE summer heat battery drainage.
                  </p>
                </div>
                <div className="mt-4 flex items-center text-xs font-semibold text-brand-orange gap-1 group-hover:translate-x-1 transition-transform">
                  Read Guide <ArrowRight className="w-3.5 h-3.5" />
              ...
              <Link 
                to="/blog/iphone-15-pro-max-titanium-screen-repair-sharjah"
                className="group bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-brand-orange/40 transition-all flex flex-col justify-between"
              >
                <div>
                  <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 flex items-center justify-center font-bold mb-4">
                    15
                  </div>
                  <h3 className="font-bold text-slate-900 dark:text-white group-hover:text-brand-orange transition-colors text-base mb-2">
                    iPhone 15 Titanium & USB-C Port Fix
                  </h3>
                  <p className="text-xs text-slate-600 dark:text-slate-400 line-clamp-3">
                    Grade 5 Titanium chassis realignment, burnt USB-C connector replacements, and Super Retina XDR swaps.
                  </p>
                </div>
                <div className="mt-4 flex items-center text-xs font-semibold text-brand-orange gap-1 group-hover:translate-x-1 transition-transform">
                  Read Guide <ArrowRight className="w-3.5 h-3.5" />
            ...
            <div className="mt-8 p-6 bg-slate-100/60 dark:bg-slate-800/40 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                <Link to="/samsung-repair" className="px-3 py-1.5 rounded-lg bg-white dark:bg-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-brand-orange border border-slate-200 dark:border-slate-700 transition-colors">
