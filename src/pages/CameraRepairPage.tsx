...
import { Camera, Eye, ShieldCheck, CheckCircle2, ArrowRight, Zap, Sparkles, RefreshCw, Focus, Video } from 'lucide-react';
...
export default function CameraRepairPage({ onBookNow }: CameraRepairPageProps) {
  ...
  return (
    <>
      <Helmet>
        <link rel="canonical" href="https://allsharq.com/camera-repair" />
        <title>Camera Lens & Sensor Repair Sharjah | Al Sharq Mobile</title>
        <meta name="description" content="Expert front & rear camera replacement, sapphire lens fix, and blurry focus repair for iPhone, Samsung, and Android in Sharjah." />
      ...
      <div className="pt-24 pb-16 bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Breadcrumbs items={[
            ...
            { label: 'Camera Repair', path: '/camera-repair' }
          ]} />
          ...
          <div className="mt-6 bg-gradient-to-br from-brand-blue to-slate-900 rounded-3xl p-8 sm:p-12 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="max-w-3xl relative z-10">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-md text-brand-orange font-semibold text-xs sm:text-sm mb-6 border border-white/10">
                ...
                <span>Ultra-Precision Optics Lab • Muwaileh</span>
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight leading-tight mb-6">
                Restore Crystal-Clear Photos with OEM Camera & Lens Repair
              </h1>
              <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-8">
                Shaky autofocus, cracked sapphire glass, black viewfinder screens, or scratched lenses? Our certified technicians restore original HDR capture and LiDAR functionality using Grade-A OEM camera modules.
              </p>
          ...
          <div className="mt-16">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4">
                Common Camera Issues We Solve Daily
              </h2>
              <p className="text-slate-600 dark:text-slate-400">
                Fast turnarounds in 30-45 minutes in our Sharjah workshop.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'External sapphire camera glass shattered? We replace individual lens covers without disturbing the sensitive sensor underneath.'
                },
                {
                  icon: Focus,
                  title: 'Jittering / Buzzing OIS',
                  desc: 'Camera vibrating or buzzing violently while recording? We repair damaged Optical Image Stabilization magnets and gyros.'
                },
                {
                  icon: Sparkles,
                  title: 'Dust / Fog Under Glass',
                  desc: 'Moisture or debris trapped behind the lens causing blurry photos? We clean optics in our laminar flow cleanroom.'
                },
                {
                  icon: Video,
                  title: 'Black Camera Screen',
                  desc: 'Viewfinder shows pure black or flashlight disabled? We diagnose logic board camera power rails and replace faulty ICs.'
                },
                {
                  icon: Zap,
                  title: 'Front TrueDepth / Face ID',
                  desc: 'Repair front selfie sensors and dot projectors safely to retain facial recognition and TrueDepth sensors.'
                },
                {
                  icon: RefreshCw,
                  title: 'Full Module Replacement',
                  desc: 'Complete OEM multi-camera module swaps for triple-lens arrays (wide, ultra-wide, and periscope telephoto).'
                }
              ].map((item, idx) => (
          ...
          <div className="mt-16 bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">90-Day Parts & Labor Warranty</h3>
                <p className="text-slate-600 dark:text-slate-400 text-sm">Every camera repair is covered by our comprehensive warranty and tested for focus accuracy.</p>
              </div>
            </div>
            <button
              onClick={handleBook}
